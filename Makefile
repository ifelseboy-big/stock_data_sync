.PHONY: server-install server-dev scheduler-dev server-check web-install web-dev web-check check performance live-validation live-etf-validation live-full-validation live-ths-theme-validation release
