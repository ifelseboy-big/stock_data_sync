...
2026-07-19 通过后台 `REPAIR` 命令和正式采集、Parquet 封存、批次关闭、依赖解析、全局串行加工链路，单独验证 `ths_index`、`ths_member` 和 `ths_daily`。验证日期为 2026-07-17，PostgreSQL 为 18.4，迁移版本为 `20260719_0005`。
